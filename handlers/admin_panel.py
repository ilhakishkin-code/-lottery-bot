...
async def gv_notify_all(callback: CallbackQuery, bot: Bot):
    ...
    text = (
        f"<tg-emoji emoji-id=\"5195058485506648605\">👋</tg-emoji><b>Поздравляем с победой, вы выиграли PlayStation 5 от GGSel!</b>\n\n"
        ...
        f"<tg-emoji emoji-id=\"5195202345436224393\">🫰</tg-emoji><b>Чтобы получить выигрыш, напишите пожалуйста нашему менеджеру GGSel: @ggselevens</b>\n"
        "<blockquote>"
        ...
        "</blockquote>\n\n"
        f"<tg-emoji emoji-id=\"5447644880824181073\">⚠️</tg-emoji><b>Внимание: До того пока не свяжетесь с менеджером, не сообщайте третьим лицам о выйгрыше (в группы, знакомым в интернете и т.д), чтобы избежать мошенничества и потери вашего приза! Если вами представится другой человек и менеджер передаст ему приз, администрация GGSel не будет возмещать ущерб или выдавать приз повторно!</b>"
    )
